...
export async function loader() {
    return json({
      ENV: {
        BUNDLER_URL:process.env.BUNDLER_URL, PAYMASTER_URL: process.env.PAYMASTER_URL, PASSKEY_SERVER_URL: process.env.PASSKEY_SERVER_URL,
      },
    });
  }
...
export default function Home() {
    const {ENV} = useLoaderData() as { ENV: {BUNDLER_URL:string,PAYMASTER_URL:string,PASSKEY_SERVER_URL:string} };
    const { BUNDLER_URL, PAYMASTER_URL, PASSKEY_SERVER_URL } = ENV;
    const CHAIN = sepolia
